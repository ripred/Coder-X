...
CONFIG_PATH = os.environ.get("CODER_X_CONFIG") or os.path.expanduser("~/.coder_x_config.json")
def get_config_path() -> str:
    return os.environ.get("CODER_X_CONFIG") or os.path.expanduser("~/.coder_x_config.json")
